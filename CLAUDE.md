...
The active line is **Phase 7 release engineering** (v0.1 public release) and **Phase 13 — modules / type-system stability** (the next language-surface phase). **Phase 12 closed 2026-05-05** per `docs/changes/2026-05-05-phase-12-closeout.md` — all twelve sessions shipped; the Steam-class .exe deliverable is reproducible from `examples/survive_demo/`. Closed phases:
