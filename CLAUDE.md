...
The active line is **Phase 7 release engineering** (v0.1 public release) and **Phase 14 — beta + dogfood** (the next language-surface phase). **Phase 13 closed 2026-05-06** per `docs/changes/2026-05-06-phase-13-closeout.md` — all twelve sessions shipped; modules + structural records + lax-strict + verified-mode JSON + `@deprecated` + EXIT GATE multi-file demos all land. Closed phases:
